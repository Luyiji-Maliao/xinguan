...
public class SimpleHibernateDao<T, PK extends Serializable> {
	 ...
	 * 在构造函数中定义对象类型Class.
	 * eg.
	 * SimpleHibernateDao<User, Integer> userDao = new SimpleHibernateDao<User, Integer>(sessionFactory, User.class);
	 */
	...
	public <T> List<T> entityBySql2(String sql,Class c){
		return getSession().createNativeQuery(sql).setResultTransformer(Transformers.aliasToBean(c)).list();
	}
