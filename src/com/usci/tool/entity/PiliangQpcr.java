...
public class PiliangQpcr {
	...
	//读数
	private String feedbackReading;
	//浓度
	...
	public String getFeedbackReading() {
		return feedbackReading;
	}
	public void setFeedbackReading(String feedbackReading) {
		this.feedbackReading = feedbackReading;
	}
	...
	public String getQpcrNumber() {
		return qpcrNumber;
	}
	public void setQpcrNumber(String qpcrNumber) {
		this.qpcrNumber = qpcrNumber;
	}
