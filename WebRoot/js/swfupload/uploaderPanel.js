...
keel.UploadPanel = function(cfg){
	...
	this.gp = new Ext.grid.GridPanel({
	    ...
	    columns: [
	        ...
	        {header: '文件名', width: 140, sortable: true,dataIndex: 'name', menuDisabled:true},
	        ...
	        {header: '&nbsp;',width:0,dataIndex:'id', menuDisabled:true,renderer:this.formatDelBtn}       
	    ]			
	});
	this.setting = {
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			...
			{text:'清空列表',ref:'../deleteBtn',iconCls:'delete2',handler:this.deleteAll,scope:this},'-'
		],
		layout : 'fit',
		items : [this.gp],
		listeners : {
...
Ext.extend(keel.UploadPanel,Ext.Panel,{
	...
	formatDelBtn : function(v){
		return "<a href='#' id='"+v+"'  style='color:blue' class='link-btn' ext:qtip='移除该文件'></a>";
	},
