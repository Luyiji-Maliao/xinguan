/**
 * 日期选择组件，包含时分秒（包含时分秒勾起来，要考）
 * 1、在jsp中引入本js
 * 2、需要添加此组件的form中添加 requires:'MyApp.ux.DateTimeField',
 * 3、format: 'Y-m-d H:i:s',
 * 4、xtype: 'datetimefield',
...
Ext.define('MyApp.ux.TimePickerField', {
      ...
      */
      ...
      initComponent: function() {
          ...
          // TODO ʹ��timeformat �ж��Ƿ񴴽��������, maybe second field is not always need.
      ...
      // ���ε��ø��������, call each spinner's function
